class User<T,K> {
  ...
  const alex = new User("Same","DataTypes");
  const num = new User (3333, 4434);
  const test = new User(2, "DataTypes");
  console.log(alex.getPw());
  console.log(num.getPw());
  console.log(test.getPw());
  ...
  const alex2 = new User2("Alex",28);
  const num2 = new User2 (3333, 4434);
  const test2 = new User2(2, 22);  //Argument of type 'string' is not assignable to parameter of type 'number'.
  console.log(alex2.getSecret());
  console.log(num2.getSecret());
